...
function showPrivacyPolicy() {
    openModal(t('rgpd.privacy_policy'), `
        <div class="legal-content">
            ...
            <p>La présente politique de confidentialité décrit comment ACL GESTION SAS collecte, utilise et protège vos données personnelles conformément au Règlement Général sur la Protection des Données (RGPD - Règlement UE 2016/679) et à la loi Informatique et Libertés du 6 janvier 1978 modifiée.</p>
            ...
            <p>
                ...
                Contact protection des données : <strong>contact@acl-gestion.com</strong>
            </p>

            <h4>3. Données collectées</h4>
            <p>Nous collectons les données suivantes :</p>
            <ul>
                <li><strong>Données d'identification :</strong> nom, prénom, email professionnel, téléphone</li>
                <li><strong>Données professionnelles :</strong> fonction, rôle, hôtel(s) d'affectation</li>
                <li><strong>Données de connexion :</strong> adresse IP, logs d'accès, horodatage, navigateur</li>
                <li><strong>Données d'utilisation :</strong> actions effectuées dans l'application (journal d'audit)</li>
                <li><strong>Données financières :</strong> données de clôtures, factures (dans le cadre de la gestion hôtelière)</li>
            </ul>
            ...
            <ul>
                ...
                <li>Sécurité, prévention des fraudes et traçabilité des opérations</li>
            ...
            <ul>
                <li><strong>L'exécution du contrat :</strong> fourniture du service SaaS souscrit</li>
                <li><strong>L'intérêt légitime :</strong> sécurité, amélioration du service, statistiques d'usage</li>
            ...
            <p>Vos données sont accessibles uniquement aux personnes habilitées au sein de votre organisation (selon les rôles et permissions configurés) et au personnel technique d'ACL GESTION pour la maintenance du service. Aucune donnée n'est vendue ou transmise à des tiers à des fins commerciales.</p>

            <h4>7. Transferts hors UE</h4>
            <p>Vos données sont hébergées en France (OVH SAS, Roubaix). Aucun transfert de données hors de l'Union Européenne n'est effectué.</p>

            <h4>8. Durée de conservation</h4>
            <ul>
                <li><strong>Données de compte :</strong> durée du contrat + 3 ans après résiliation</li>
            ...
            <h4>10. Sécurité</h4>
            <p>Nous mettons en œuvre des mesures techniques et organisationnelles appropriées : chiffrement SSL/TLS, authentification JWT, contrôle d'accès par rôles (RBAC), journalisation des accès, sauvegardes quotidiennes, hébergement sécurisé en France.</p>

            <h4>11. Cookies</h4>
            <p>L'application utilise exclusivement des cookies techniques nécessaires à son fonctionnement (authentification, préférences d'affichage). Aucun cookie publicitaire ou de tracking n'est utilisé.</p>

            <h4>12. Réclamation</h4>
    ...
    openModal(t('rgpd.legal_notice'), `
        <div class="legal-content">
            ...
            <p>
                ...
                Siège social : 22 Avenue de Châlons, 93150 Le Blanc-Mesnil, France<br>
            ...
            <p>Le directeur de la publication est le représentant légal d'ACL GESTION SAS.</p>
            ...
            <p>L'ensemble du contenu de cette application (textes, images, logos, logiciels, code source, bases de données, architecture) est la propriété exclusive d'ACL GESTION SAS et est protégé par les lois françaises et internationales relatives à la propriété intellectuelle. Toute reproduction, représentation, modification ou exploitation non autorisée est interdite et constitue une contrefaçon sanctionnée par les articles L.335-2 et suivants du Code de la propriété intellectuelle.</p>

            <h4>5. Protection des données personnelles</h4>
            <p>Conformément au RGPD et à la loi Informatique et Libertés, vous disposez de droits sur vos données personnelles. Consultez notre <a href="#" onclick="closeModal(); setTimeout(showPrivacyPolicy, 300); return false;">Politique de confidentialité</a> pour plus d'informations.<br>
            Contact protection des données : <strong>contact@acl-gestion.com</strong></p>

            <h4>6. Cookies</h4>
            <p>Cette application utilise exclusivement des cookies techniques nécessaires à son fonctionnement (authentification, préférences). Aucun cookie publicitaire ou de suivi tiers n'est utilisé.</p>

            <h4>7. Limitation de responsabilité</h4>
            <p>ACL GESTION SAS s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur la plateforme. Toutefois, ACL GESTION SAS ne saurait être tenue responsable des erreurs, omissions, indisponibilités ou des résultats obtenus suite à l'utilisation de ces informations. L'utilisateur est seul responsable de l'utilisation qu'il fait du service.</p>

            <h4>8. Droit applicable et juridiction</h4>
            <p>Les présentes mentions légales sont soumises au droit français. En cas de litige, les tribunaux compétents de Bobigny seront seuls compétents.</p>
    ...
    openModal('Conditions Générales de Vente', \`
        <div class="legal-content">
            ...
            <p>
                ...
                Siège social : 22 Avenue de Châlons, 93150 Le Blanc-Mesnil<br>
                SIRET : 845 388 222 00018 — RCS Bobigny<br>
                TVA intracommunautaire : FR59 845 388 222
            </p>

            <h4>3. Description du service</h4>
            <p>ACL GESTION est une plateforme SaaS (Software as a Service) de gestion hôtelière multi-établissements accessible via navigateur web et application mobile. Le service comprend l'ensemble des modules fonctionnels décrits sur le site, l'hébergement des données, la maintenance corrective et évolutive, et le support technique.</p>

            <h4>4. Souscription et durée</h4>
            <p>La souscription s'effectue par signature d'un bon de commande ou acceptation d'un devis. Le contrat prend effet à la date d'activation du compte. La durée initiale et les conditions de renouvellement sont précisées dans le bon de commande. À défaut, l'abonnement est mensuel avec un préavis de résiliation de 30 jours.</p>

            <h4>5. Tarification et paiement</h4>
            <ul>
                <li>Les tarifs sont exprimés en euros hors taxes (HT) et communiqués sur devis personnalisé.</li>
                <li>La TVA applicable est celle en vigueur au jour de la facturation (20%).</li>
                <li>Les factures sont payables à 30 jours date de facture, sauf accord contraire.</li>
                <li>Tout retard de paiement entraîne de plein droit l'application de pénalités de retard au taux annuel de 3 fois le taux d'intérêt légal, ainsi qu'une indemnité forfaitaire de 40 euros pour frais de recouvrement (art. L.441-10 du Code de commerce).</li>
                <li>Le Prestataire se réserve le droit de suspendre l'accès au service en cas de non-paiement après mise en demeure restée infructueuse pendant 15 jours.</li>
            </ul>

            <h4>6. Obligations du Prestataire</h4>
            <ul>
                <li>Fournir un service conforme à la description et aux spécifications convenues.</li>
                <li>Assurer la disponibilité du service avec un taux de disponibilité cible de 99,5% (hors maintenance planifiée).</li>
                <li>Héberger les données en France, chez OVH SAS (Roubaix).</li>
                <li>Assurer la sauvegarde quotidienne des données.</li>
                <li>Assurer le support technique par email aux heures ouvrables (lundi-vendredi, 9h-18h).</li>
                <li>Informer le Client de toute maintenance planifiée avec un préavis minimum de 48 heures.</li>
            </ul>

            <h4>7. Obligations du Client</h4>
            <ul>
                <li>Fournir des informations exactes et à jour lors de l'inscription.</li>
                <li>Assurer la confidentialité des identifiants d'accès.</li>
                <li>Utiliser le service conformément à sa destination et aux présentes CGV.</li>
                <li>S'acquitter des sommes dues dans les délais impartis.</li>
                <li>Respecter la réglementation applicable, notamment en matière de protection des données.</li>
            </ul>

            <h4>8. Propriété intellectuelle</h4>
            <p>Le service ACL GESTION, ses logiciels, interfaces, bases de données, documentation et tout élément associé sont et demeurent la propriété exclusive d'ACL GESTION SAS. La souscription confère uniquement un droit d'utilisation non exclusif, non cessible et non transférable, pour la durée du contrat.</p>

            <h4>9. Données du Client</h4>
            <p>Le Client reste propriétaire de l'ensemble des données qu'il saisit dans la plateforme. ACL GESTION SAS s'interdit toute utilisation des données du Client à des fins autres que la fourniture du service. En cas de résiliation, le Client peut exporter ses données pendant une période de 30 jours. Au-delà, les données seront supprimées.</p>

            <h4>10. Limitation de responsabilité</h4>
            <ul>
                <li>La responsabilité du Prestataire est limitée aux dommages directs et prévisibles, et ne saurait excéder le montant des sommes versées par le Client au titre des 12 derniers mois.</li>
                <li>Le Prestataire ne saurait être tenu responsable des dommages indirects (perte de chiffre d'affaires, perte de données due à un cas de force majeure, préjudice commercial).</li>
                <li>Le Prestataire ne saurait être tenu responsable des contenus saisis par le Client ou ses utilisateurs.</li>
            </ul>

            <h4>11. Force majeure</h4>
            <p>Aucune des parties ne pourra être tenue responsable de l'inexécution de ses obligations en cas de force majeure au sens de l'article 1218 du Code civil (catastrophe naturelle, pandémie, guerre, grève générale, panne de réseau internet, cyberattaque d'ampleur exceptionnelle).</p>

            <h4>12. Résiliation</h4>
            <ul>
                <li>Chaque partie peut résilier le contrat avec un préavis de 30 jours avant la date de renouvellement.</li>
                <li>En cas de manquement grave par l'une des parties, l'autre partie pourra résilier de plein droit après mise en demeure restée sans effet pendant 15 jours.</li>
                <li>Le Client peut exporter ses données via les fonctionnalités prévues à cet effet (export CSV, PDF, ZIP).</li>
            </ul>

            <h4>13. Protection des données</h4>
            <p>Le Prestataire agit en qualité de sous-traitant au sens du RGPD pour les données personnelles traitées par le Client via la plateforme. Les modalités de traitement sont détaillées dans notre <a href="#" onclick="closeModal(); setTimeout(showPrivacyPolicy, 300); return false;">Politique de confidentialité</a>.</p>
...
function showCGU() {
    openModal("Conditions Générales d'Utilisation", \`
        <div class="legal-content">
            ...
            <h4>2. Définitions</h4>
            <ul>
                <li><strong>"Plateforme" :</strong> l'application web et mobile ACL GESTION accessible à l'adresse acl-gestion.com.</li>
                <li><strong>"Éditeur" :</strong> ACL GESTION SAS, 22 Avenue de Châlons, 93150 Le Blanc-Mesnil (SIRET 845 388 222 00018).</li>
                <li><strong>"Utilisateur" :</strong> toute personne disposant d'un compte d'accès à la plateforme.</li>
                <li><strong>"Client" :</strong> la personne morale ayant souscrit un abonnement au service.</li>
                <li><strong>"Contenu" :</strong> toute donnée, fichier, texte ou document saisi ou téléversé par l'Utilisateur.</li>
            </ul>

            <h4>3. Accès à la plateforme</h4>
            <p>L'accès à la plateforme est réservé aux Utilisateurs disposant d'un compte valide, créé par le Client ou son administrateur. L'Utilisateur s'engage à :</p>
            <ul>
                <li>Fournir des informations exactes lors de la création de son profil.</li>
                <li>Préserver la confidentialité de ses identifiants de connexion (email et mot de passe).</li>
                <li>Ne pas partager, céder ou communiquer ses identifiants à des tiers.</li>
                <li>Informer immédiatement l'administrateur de toute utilisation non autorisée de son compte.</li>
            </ul>
            <p>L'Utilisateur est responsable de toute action effectuée depuis son compte.</p>

            <h4>4. Utilisation autorisée</h4>
            <p>La plateforme est destinée exclusivement à la gestion opérationnelle d'établissements hôteliers. L'Utilisateur s'engage à utiliser la plateforme conformément à sa destination professionnelle et dans le respect de la réglementation en vigueur.</p>

            <h4>5. Comportements interdits</h4>
            <p>Il est strictement interdit de :</p>
            <ul>
                <li>Tenter d'accéder à des données ou fonctionnalités non autorisées par son rôle.</li>
                <li>Contourner, désactiver ou interférer avec les mécanismes de sécurité de la plateforme.</li>
                <li>Utiliser la plateforme à des fins illicites, frauduleuses ou contraires à l'ordre public.</li>
                <li>Introduire des virus, logiciels malveillants ou tout code nuisible.</li>
                <li>Procéder à l'extraction systématique ou automatisée de données (scraping, crawling).</li>
                <li>Reproduire, copier, décompiler, désassembler ou procéder à l'ingénierie inverse du logiciel.</li>
            ...
            <p>L'ensemble des éléments de la plateforme (logiciels, code source, interfaces, design, bases de données, textes, logos, marques) est la propriété exclusive d'ACL GESTION SAS, protégé par le droit d'auteur, le droit des marques et le droit des bases de données. L'Utilisateur ne dispose d'aucun droit de propriété intellectuelle sur la plateforme. Toute reproduction, même partielle, est interdite sans autorisation écrite préalable.</p>

            <h4>7. Contenu de l'Utilisateur</h4>
            <ul>
                <li>L'Utilisateur reste propriétaire des données et contenus qu'il saisit dans la plateforme.</li>
                <li>L'Utilisateur garantit que les contenus qu'il publie ne portent pas atteinte aux droits de tiers et sont conformes à la réglementation.</li>
                <li>L'Éditeur se réserve le droit de supprimer tout contenu manifestement illicite, après notification.</li>
                <li>L'Éditeur n'exerce aucun contrôle préalable sur les contenus saisis par les Utilisateurs.</li>
            </ul>

            <h4>8. Disponibilité du service</h4>
            <p>L'Éditeur s'efforce d'assurer la disponibilité de la plateforme 24h/24 et 7j/7. Toutefois, l'Éditeur ne garantit pas une disponibilité ininterrompue et ne saurait être tenu responsable des interruptions liées à :</p>
            <ul>
                <li>Des opérations de maintenance planifiées ou urgentes.</li>
                <li>Des pannes ou défaillances des réseaux de télécommunications.</li>
                <li>Des cas de force majeure.</li>
                <li>Des actes de malveillance ou intrusions informatiques.</li>
            </ul>

            <h4>9. Responsabilité de l'Éditeur</h4>
            <ul>
                <li>L'Éditeur n'est tenu que d'une obligation de moyens concernant le fonctionnement de la plateforme.</li>
                <li>L'Éditeur ne saurait être tenu responsable des dommages indirects subis par l'Utilisateur (perte de données, perte de chiffre d'affaires, préjudice commercial, atteinte à l'image).</li>
                <li>L'Éditeur ne saurait être tenu responsable de l'utilisation faite par l'Utilisateur du service, ni des décisions prises sur la base des informations fournies par la plateforme.</li>
                <li>En tout état de cause, la responsabilité de l'Éditeur est plafonnée au montant des sommes effectivement versées par le Client au titre des 12 derniers mois.</li>
            </ul>

            <h4>10. Responsabilité de l'Utilisateur</h4>
            <ul>
                <li>L'Utilisateur est seul responsable de l'utilisation qu'il fait de la plateforme et des contenus qu'il y saisit.</li>
                <li>L'Utilisateur s'engage à indemniser et garantir l'Éditeur contre toute réclamation, action ou plainte de tiers résultant de son utilisation de la plateforme.</li>
                <li>L'Utilisateur est responsable de la sécurité de ses équipements et de sa connexion internet.</li>
            </ul>

            <h4>11. Protection des données personnelles</h4>
            <p>Le traitement des données personnelles est détaillé dans notre <a href="#" onclick="closeModal(); setTimeout(showPrivacyPolicy, 300); return false;">Politique de confidentialité</a>. L'Utilisateur dispose des droits d'accès, rectification, suppression, portabilité, opposition et limitation du traitement. Contact : <strong>contact@acl-gestion.com</strong></p>

            <h4>12. Suspension et résiliation</h4>
            <ul>
                <li>L'Éditeur se réserve le droit de suspendre ou supprimer l'accès d'un Utilisateur en cas de violation des présentes CGU, sans préavis en cas de manquement grave.</li>
                <li>En cas de suspension, l'Utilisateur sera informé par email des motifs de la suspension.</li>
                <li>Le Client pourra demander la réactivation du compte après régularisation de la situation.</li>
            </ul>

            <h4>13. Modification des CGU</h4>
            <p>L'Éditeur se réserve le droit de modifier les présentes CGU à tout moment. Les Utilisateurs seront informés de toute modification substantielle par notification dans l'application ou par email. L'utilisation continue de la plateforme après notification vaut acceptation des CGU modifiées.</p>

            <h4>14. Droit applicable et litiges</h4>
            <p>Les présentes CGU sont soumises au droit français. En cas de litige, les parties s'efforceront de trouver une solution amiable. À défaut, les tribunaux de Bobigny seront seuls compétents.</p>
